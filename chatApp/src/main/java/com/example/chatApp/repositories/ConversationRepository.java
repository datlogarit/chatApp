...
//    @Query(value = "SELECT m FROM MemberOfConversation m WHERE m.userId.id != :id và cùng conversation với user dang truyen")
//    List<MemberOfConversation> findListConversationByUserId(@Param("id") Integer id);
@Query(value = """
